...
> **2026-09-06:** 이 글은 TripFit 시절(2026-07~09) 하네스 v1의 기록이다. 2026-09-05~06에 하네스를 범용 부품으로 재편했고(v2 — 슬롯·플래그·씨앗·훅 규약·Stop & Ask), 그 설계와 결정은 `docs/specs/cross-cutting/harness-slot-system-v2.md`와 `docs/out-of-scope/README.md`에 있다. 본문의 파일 이름·개수는 v1 기준이라 현행과 다르며, 현행은 `.claude/rules/README.md`가 SSOT다. 이 문서는 새 프로젝트에 배달하지 않는다.
